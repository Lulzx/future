...
[Game 4](../02-games/4-labor.md) models the gap as an **unmitigated commons failure.**
...
- **Firms discover that seniors depreciate faster than expected** and re-price junior pipelines as strategic rather than as cost. The commons failure resolves privately once the time horizon on the cost shortens enough to appear in someone's planning window.

- **Professional bodies mandate training ratios.** The medical residency model exists precisely because this failure was solved once already - an entire profession recognized that individually rational hiring destroyed the pipeline and imposed a collective rule. There is a working template.
