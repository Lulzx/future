---
title: The Productivity Boom Is Waiting on Retirements
dek: Factories owned electric motors for twenty years before productivity moved, because the men who built their careers on the old floor plan were still running the plants. The AI J-curve resolves on the same clock, and the clock is management turnover.
date: 2026-08-10
tags: productivity, organizations, management
takeaway: Installing the tool takes a quarter. Reorganizing around the assumption that first drafts are free and verification is scarce takes a generation of managers, and the statistics move when the cohort does.
corpus: 04-timelines/2028-2032.md, 02-games/4-labor.md, 09-macro/prices.md, 07-indicators/diffusion/README.md
---
...
[The corpus](../04-timelines/2028-2032.md) hangs its whole middle period on this precedent, and states the mechanism in a sentence this post exists to unpack: **organizational redesign runs at the speed of management turnover.** That is a mechanism, not a metaphor, and it comes with a schedule and a test.
...
![Same sector, same year, same tools available. One firm rebuilt the floor, one bought licenses, and the gap between their chimneys is the whole mechanism made visible.](img/two-factories.avif)
...
- **The Dispersion Test resolves flat.** Exposed-sector productivity rises with no widening between firms by the late 2020s. The frictionless-tool story wins, the turnover mechanism was this cycle's wrong analogy, and the corpus's middle-period dates all shift earlier.
- **Incumbent transformation outruns entry.** If the large firms that installed copilots in 2024 to 2026 show the redesign signatures, widened spans, restructured review, changed junior mix, without waiting on leadership succession, then managerial self-expropriation turned out easier than the precedent implies.
- **The J-curve never turns.** If by the early 2030s measured productivity still has not moved even net of the mismeasurement caveats, the problem was never the floor plan, and something deeper in the capability story failed. This post's scorecard row, keyed to the corpus's own productivity claim, resolves no at its stated 20%.
- **The scorecard row's honest shape:** the corpus holds a visible-by-2030 productivity step-up at only 20%, precisely because turnover is slow. This post is a mechanism bet, not an optimism bet, and the row is written so that being right about the mechanism and the lag scores as being right.
