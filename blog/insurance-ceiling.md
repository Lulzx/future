...
![The inspector with the magnifying glass got there decades before the law did, because the explosion was going to be billed to the carrier.](img/boiler-inspector.avif)

The figure peering at the boiler in that drawing is not from the government. They are from the carrier, and the factory owner waiting behind them understands the real rule of the era: the machine runs when the inspector says it runs.
