---
title: The Better AI Works, the More It Costs to Finance
dek: A real productivity boom raises the neutral interest rate, which discounts every long-dated asset more harshly, including the AI build itself. The likeliest world is stranger: AI works well enough to matter, and rates stay low anyway.
date: 2026-08-08
tags: rates, macro, capital
takeaway: Every capex projection quietly assumes financing costs stay fixed while the technology succeeds. Those two assumptions fight each other, and only demography keeps the fight from being decided quickly.
corpus: 09-macro/rates.md, 01-substrate/capital.md, 09-macro/demography.md, 09-macro/fiscal.md, 02-games/3-firms.md
---
...
![The balloon rises, and the same rope hauls the anchor up toward the basket.](img/balloon-anchor.avif)
...
| Force | Direction on rates | Size | Confidence |
|---|---|---|---|
| Productivity step-up | Up | Large, if it lands at all | Conditional |
| Demographics | Down | Large and highly predictable | High |
| Capital-income concentration | Down | Moderate | Moderate |
| Fiscal deterioration | Up | Moderate to large | Moderate |
...
[The refinancing post](capex-verdict.md) is about credit: haircuts on melting collateral, refinancing walls, the migration from operating cash to structured debt. Credit events happen at spreads, not at the risk-free rate, and a neocloud can hit its wall with Treasuries at 2% just fine. This post is about the level underneath: what the whole build earns relative to what capital costs, over decades. The Success Tax operates on that layer, and it bites hardest exactly in the scenario where everything goes *right*, the scenario the credit post spends least time in. Together they bracket the outcome space: if AI disappoints, the Verdict reverses and the credit layer breaks. If AI succeeds, the Success Tax arrives and the discount layer tightens. The only path with neither is the narrow one where AI works modestly, demography keeps rates pinned, and the financing stack grows into its obligations. That narrow path is, per the 30%, the modal one. It is still narrow, and the build is priced as if it were wide.

There is one more interaction, and it runs through the state. [Fiscal deterioration](../09-macro/fiscal.md) pushes rates up as an aging tax base meets rising transfer and interest costs. If AI compresses the labor share of the tax take while adding displacement-driven transfer demand, the fiscal force strengthens from inside the AI story itself. Watch interest expense as a share of government revenue: it is the number that converts this post's abstractions into politics.

## What would prove this post wrong

- **Real rates rise more than 100 basis points, sustained, by 2035, with TFP visibly moving.** The 30% scenario lands, the Success Tax beats the Tide, and the surprise is that it happened this decade rather than next. The scorecard row resolves yes.
- **Rates stay pinned and productivity never shows.** Then the whole question was moot: no step-up, no tax, and the interesting failure is in the capability story, not the macro.
- **The concentration channel fails.** If AI's gains show up broadly in wages, the savings-glut offset weakens, rates get more upward pressure than forecast, and, worth noticing, the distributional story of half this blog improves at the price of this post's arithmetic.
- **Fiscal dominance takes over.** If deficits push rates up regardless of AI, the signal is unreadable: rates rise for reasons this post did not forecast, and the row resolves on a technicality. The honest response would be to say so in the annotation rather than claim credit.
