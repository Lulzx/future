...
**Load-bearing risks (can invalidate large branches):** Taiwanese fab continuity (~90% modelling assumption), learned verification defeating the master asymmetry, correlated-failure insurability as the real deployment ceiling.
