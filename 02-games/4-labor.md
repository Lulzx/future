...
- **~60% of US employment** sits in occupations where ≥20% of tasks are meaningfully AI-exposed.

- But *exposure ≠ substitution*. RCT evidence is genuinely mixed: **+14%** for customer support agents, **+25–40%** for consultants on in-domain tasks, **+26–55%** in some coding studies - yet METR found experienced open-source developers were **19% slower** with AI assistance while believing they were 20% faster.
...
- **Historical diffusion lag.** Electrification took ~40 years to show up in productivity statistics because factories had to be physically redesigned around unit drive. ERP took ~10. AI ships over existing rails and self-serves, so it's faster - but the binding constraint is organizational redesign, not model capability, and **org redesign runs at the speed of management turnover.**
...
- **Junior knowledge roles and middle-skill cognitive tasks** - coordination, documentation, first-pass analysis, routine review - absorb the large majority of the pressure in this window.
- **Physical, care, and high-stakes-liability roles** absorb very little of it before ~2032. The constraint there is bodies and licensure, not intelligence.
- **Geography compounds it.** Exposure is spatially clustered in metros and regions built on a single exposed sector, exactly as manufacturing decline was.
...
| Junior software and data postings | Down on the order of **60%+** from peak in several trackers |
...
> **Assessment:** roughly **50%** of the entry-level decline is AI substitution, **30%** cyclical, **20%** work-organization. That split is held with low confidence and is the single number in this document most likely to be revised.
...
**50/30/20 is the weakest number on the page.** Treat it as a prior to be destroyed by the 2027–28 recovery test, not as a stable parameter. If juniors recover with the cycle, rewrite toward cyclical/remote; if not, raise substitution and promote [Uncertainty 3](../06-uncertainties/apprenticeship-gap.md).
...
**Next:** [Game 5 - Information](5-information.md)
