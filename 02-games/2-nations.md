...
The practical implication: the highest-leverage governance work right now is not advocacy. It is having the good version of the architecture drafted, defensible, and on the shelf before the window opens, because the window will be short and whatever is ready will win.

---

**Related:** [Energy](../01-substrate/energy.md) on who can actually build capacity · [Geopolitics](../03-domains/geopolitics.md) · [Probabilities](../05-probabilities/README.md) on why the incident row matters more than the tail row
