...
All four converge because all four are downstream of generation becoming free. That convergence is why the [compressed version](../00-overview/compressed.md) ends where it does.
