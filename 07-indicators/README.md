...
| **Internal research cycle time** per validated experiment at frontier labs | Not disclosed; infer from release cadence and paper throughput | Sustained >2× compression | [Uncertainty 1](../06-uncertainties/recursive-self-improvement.md) — the RSI loop closing |
...
| **Teleoperation-to-autonomy ratio** in deployed robots | Overwhelmingly teleoperated or scripted | Autonomy share crossing 50% on unstructured tasks | [Robotics](../03-domains/physical/robotics.md) — the 2030s swing variable |
