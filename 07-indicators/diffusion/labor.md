# Diffusion - Labor and Institutions (B1, B6, B10, B11)

← [B - Diffusion](README.md) · [Part VII](../README.md)

---

The people side of diffusion: hiring composition, credentialing, the tax base, and the welfare channel. These four move on different clocks but share one data pathology - the labor story is the most surveyed and least instrumented part of the corpus, so the family rule (revealed preference over self-report) binds hardest here.
...
| **Trigger - identity channel** | Junior hiring stays depressed *and* self-reported career identity/confidence in exposed fields keeps falling after aggregate hiring recovers ([B1](labor.md)) |
...
**Next:** [The economic ledger](economy.md)
