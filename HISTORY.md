# Round log archive — rounds 0–15

← [Protocol](RESEARCH.md) · [Index](README.md)

---

Archived from [RESEARCH.md](RESEARCH.md) §5 in round 20, per the open-queue item on log drag. The protocol's working table keeps only the recent window; the full early history lives here unchanged.
...
## Split and revision notes (rounds 1–15)
...
**Related:** [Protocol](RESEARCH.md) · **Next:** [Index](README.md)
