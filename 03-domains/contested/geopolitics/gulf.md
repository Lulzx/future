...
The Gulf states are the purest test of this document's central economic claim, because they are deliberately buying the thing [Game 3](../../../02-games/3-firms.md) identifies as valuable and they have an unusual amount of it already.
...
| Complement | Position |
|---|---|
| **Energy** | Abundant, cheap, and domestically controlled - the constraint that [binds everyone else first](../../../01-substrate/energy.md) |
| **Land with power** | Effectively unlimited, and adjacent to the generation |
| **Permitting speed** | Measured in months where the US measures in years - the [constraint that actually binds](../../../06-uncertainties/power-permitting.md) |
| **Capital** | Sovereign, patient, and [not subject to commercial discipline](../../../01-substrate/capital.md) |
| **Strategic non-alignment** | Able to transact with both [blocs](bipolar.md), and courted by each |
...
The sovereign-capital point from [Capital](../../../01-substrate/capital.md) matters here more than anywhere: **a state buying strategic optionality does not stop when the NPV goes negative.** In a [correction](../../../01-substrate/compute.md), commercially-financed capacity gets culled and sovereign-financed capacity does not. The post-correction map is more Gulf-weighted than the pre-correction one.
...
1. **It breaks the compute-governance model.** [Game 2](../../../02-games/2-nations.md) treats accelerator tracking as the only plausible verification lever. Large capacity in jurisdictions outside the primary regulatory blocs, financed by states rather than firms, is exactly the configuration the lever handles worst. → [C3](../../../07-indicators/governance.md)
...
**Next:** [The Global South](global-south.md)
