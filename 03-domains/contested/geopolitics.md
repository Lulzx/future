...
For countries whose growth model is labor cost arbitrage, this is an **existential structural problem arriving in the 2030s**, not a competitiveness problem.

India's ~$250B IT services export sector sits directly in the path of the first wave. Its demographic dividend depends on absorbing **~10M new workers/year** into exactly the sectors under pressure. The arithmetic does not resolve itself: the sectors that were supposed to absorb the cohort are the ones being compressed.
