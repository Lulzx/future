...
The slowest-moving item in this document and possibly the most consequential, because it constrains the state's ability to respond to everything else in it. → [State capacity](../03-domains/contested/state-capacity.md)
