...
[Thesis](../00-overview/thesis.md) states it in one line: **deflation in anything cognition-intensive; inflation in energy, land, healthcare, and skilled trades.** This page works out what that actually does, because the consequences are larger than the observation.
...
This is [Game 3](../02-games/3-firms.md) showing up in the price index. Cognition approaches free; the inelastic complements do not; the ratio between them moves by orders of magnitude over a decade.
...
2. **Measured real growth understates true growth**, for the same reason. This partly explains why the [J-curve](../04-timelines/2028-2032.md) may look flat even in a world where welfare is rising quickly.
3. **Policy is set on the mismeasured series.** Central banks respond to the index they have.

**The transition may be considerably better for welfare than the statistics will ever show, and considerably worse for the politics, because people experience the inflating half directly and the deflating half as ambient.** Nobody notices that analysis got free; everyone notices the electricity bill. → [Energy](../01-substrate/energy.md)
