...
| 2 | 25% → **20%** | 55% → **50%** | Measured TFP is a high bar once quality-adjustment gap is priced ([prices](../09-macro/prices.md)) |
| 3 | 20% → 20% | 45% → 45% | Mechanism detail added; no directional shift in severity |
| 4 | 10% → **8%** | 35% → **30%** | Compute-governance trap ([bipolar](../03-domains/contested/geopolitics/bipolar.md)): lever and verification are the same object |
| 5 | 15% → **12%** | 60% → **55%** | Robotics four-constraint split; unstructured path harder |
| 6 | 40% → **45%** | 65% → 65% | Financing-mix migration raises credit-event odds ([capital](../01-substrate/capital.md)) |
...
| 5 | **Hold** | [B12](../07-indicators/diffusion/capability.md) operationalizes the structured-first claim into triggers; an indicator getting sharper is not evidence about the outcome |
...
**Related:** [Reasoning](reasoning.md) · [Scoring](../08-method/scoring.md) · [Protocol](../RESEARCH.md) §5
